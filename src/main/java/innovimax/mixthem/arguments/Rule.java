...
public enum Rule { 
    ...
    _RANDOM_ALT_LINE("random-alt-line", "random-altline", "will output one line of each code randomly based on a seed for reproducability", false, EnumSet.of(RuleParam._SEED)),
